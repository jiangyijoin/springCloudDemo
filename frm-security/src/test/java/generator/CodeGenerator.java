...
public class CodeGenerator {
	//项目包路径相关配置
    public static final String BASE_PACKAGE = "com.chinaoly.frm";//项目基础包名称，根据自己公司的项目修改
    public static final String PROJECT_MODULE_PACKAGE = ".security";//项目基础包名称，根据自己公司的项目修改
    public static final String MODEL_PACKAGE = BASE_PACKAGE +PROJECT_MODULE_PACKAGE+ ".Model";//Model所在包
    public static final String MAP_PACKAGE = BASE_PACKAGE +PROJECT_MODULE_PACKAGE+ ".baseDao.mapper";//DAO接口所在包
    public static final String MAPPER_PACKAGE = BASE_PACKAGE +PROJECT_MODULE_PACKAGE+ ".baseDao.mapper";//Mapper所在包
    ...
    public static final String MAPPER_INTERFACE_REFERENCE = BASE_PACKAGE + ".core.baseDao.mybatis.Mapper";//Mapper插件基础接口的完全限定名
    ...
    private static final String JDBC_USERNAME = "chinaoly";
    ...
    private static final String AUTHOR = "chenyl";//@author
    ...
    public static void main(String[] args) {
    	//genCode("输入表名");
        genCodeByCustomModelName("T_SYS_DICT","Dict");
    }
