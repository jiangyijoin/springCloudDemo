...
public class AccountInfoVo {
	...
	public OfficeTreeVo getOffice() {
		return office;
	}
	public void setOffice(OfficeTreeVo office) {
		this.office = office;
	}
	...
	public String toString() {
		return "AccountInfoVo [id=" + id + ", staffCard=" + staffCard + ", officeCode=" + officeCode + ", userLevel="
				...
				+ accDelFlag + ", office=" + office + ", officeName=" + officeName + ", levelName=" + levelName
				+ ", role=" + role + "]";
	}
