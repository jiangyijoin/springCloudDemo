...
public class EncryptUtil {
    ...
    public static String md5(String plainText) {
        ...
        try {
            result = StringUtil.bytes2HexString(
                    MessageDigest.getInstance("md5").digest(plainText.getBytes(SystemUtils.FILE_ENCODING)));
        } catch (Exception e) {
    ...
    public static String sha(String plainText) {
        ...
        try {
            result = StringUtil.bytes2HexString(
                    MessageDigest.getInstance("sha-1").digest(plainText.getBytes(SystemUtils.FILE_ENCODING)));
        } catch (Exception e) {
