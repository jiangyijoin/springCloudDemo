...
import com.chinaoly.frm.process.service.impl.WorkflowTraceService;
...
public class ActivitiController {
    ...
    public Result processList(HttpServletRequest request,Integer pageNum,Integer pageSize) {
     ...
     */
        ...
        page.setTotal(Integer.valueOf(String.valueOf(processDefinitionQuery.count())));
